...
parser.add_argument("--dataset_dir", type=str, default="/home/lx/nas/Dataset/03_RWIDE")
...
parser.add_argument(
    "--crop_size", type=int, default=64, help="Takes effect when using --crop "
)
parser.add_argument("--no_lr_sche", action="store_true", help="no lr cos schedule")
parser.add_argument(
    "--name", type=str, default="RWIDE2"
)  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
