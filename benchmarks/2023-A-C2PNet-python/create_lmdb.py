...
parser.add_argument("--name", type=str, default="RESIDE_train", help="LMDB name")
...
def data2lmdb(dpath, name="train", write_frequency=5, num_workers=8):
    dataset = RESIDE_Dataset_C2R(dpath, size="whole img")
    ...
    for idx, data in enumerate(data_loader):
        ...
        txn.put("{}".format(idx).encode("ascii"), pickle.dumps(temp))
